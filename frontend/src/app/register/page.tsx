        ...
        <div className="relative z-10 my-auto py-6 max-w-xl w-full mx-auto lg:mx-0 space-y-6">
          <div className="space-y-3">
            <h1 className="text-4xl sm:text-5xl xl:text-6xl font-serif font-black tracking-tight text-white leading-[1.08]">
              Start Y<span className="inline-flex items-center justify-center mx-0.5 text-[#c4b5fd] font-sans font-normal animate-pulse">✿</span>ur <br />
              <span className="italic font-serif font-normal text-zinc-300">Trading Journey</span>
            </h1>
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed max-w-lg font-medium">
              Join quantitative traders discovering high-probability breakout candidates and institutional option intelligence ✦
            </p>
          </div>
          ...
          <div className="bg-[#141722]/90 border border-white/10 backdrop-blur-xl rounded-2xl p-6 sm:p-8 shadow-xl space-y-4">
            <div className="grid grid-cols-2 p-1 bg-black/50 border border-white/10 rounded-xl text-xs font-bold">
              <Link
                href="/login"
                className="py-2.5 rounded-lg text-center text-zinc-400 hover:text-white transition-all"
              >
                Sign In
              </Link>
              <div className="py-2.5 rounded-lg text-center bg-[#c4b5fd] text-[#0f1017] shadow-md font-extrabold">
                Create Account
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div className="flex items-center gap-2 pt-1 px-1">
                <label className="flex items-center gap-2 cursor-pointer select-none text-zinc-300">
                  ...
                  />
                  <span className="text-[12px] font-medium">I agree to the terms &amp; disclosures</span>
                </label>
              </div>
